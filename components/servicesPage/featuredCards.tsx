		...
		<div className="w-full flex flex-col justify-between border-b border-zinc-100 dark:border-zinc-900">
			...
			<div className="flex-1 py-2">
				<div className="grid grid-cols-1 lg:grid-cols-[2fr_2fr_1fr] w-full font-onest border-b border-zinc-100 dark:border-zinc-900">
					...
					<TransitionLink href="/work/bloc" className="lg:border-r border-zinc-100 dark:border-zinc-900">
					...
					<div className="p-4 group overflow-hidden min-h-[220px] lg:min-h-0">
						<TransitionLink href="/work" className="h-full min-h-[220px] w-full bg-[#ff2d55] rounded-[10px] transition-all cursor-pointer duration-700 ease-[cubic-bezier(0.76,0,0.24,1)] lg:group-hover:scale-[1.08] lg:group-hover:rounded-none flex items-center justify-center">
